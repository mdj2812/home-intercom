...
const I18N = (() => {
  ...
  const DATA = {
    "zh-CN": {
      ...
      deviceNeverSeen: "未见过",
      devicePinsTitle: "按键房间",
      devicePinsPending: "设备上线后显示按键",
      devicePinUnassigned: "未分配",
      devicePinGpio: "GPIO %s",
      roomsTitle: "房间",
      roomsDesc: "对讲网格上的扬声器",
    ...
    en: {
      ...
      devicePinsTitle: "Button rooms",
      devicePinsPending: "Pins appear after the device hellos",
      devicePinUnassigned: "Unassigned",
      devicePinGpio: "GPIO %s",
      roomsTitle: "Rooms",
